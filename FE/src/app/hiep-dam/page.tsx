...
const getMovies = async () => {
  try {
    const res = await fetch(`${process.env.NEXT_PUBLIC_STRAPI_URL}/api/movies?populate=*&filters[hiep_dam][$eq]=true&sort=createdAt:desc`, {
...
export default async function HiepDamPage() {
  ...
  return (
    <MovieSection title="List Phim Hiếp Dâm" movies={movies} />
  )
}

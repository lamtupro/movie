...
export interface ApiActressActress extends Struct.CollectionTypeSchema {
...
export interface ApiBannerBanner extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    banner_top: Schema.Attribute.Boolean;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiMovieMovie extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    actresses: Schema.Attribute.Relation<'manyToMany', 'api::actress.actress'>;
    code: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    khong_che: Schema.Attribute.Boolean;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::actress.actress': ApiActressActress;
